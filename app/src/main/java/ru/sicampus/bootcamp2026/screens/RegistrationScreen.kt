...
fun RegistrationScreen(
    onRegistrationClick: (SNO: String, JobPost: String, email: String, password: String) -> Unit,
){
    ...
    Box(
        ...
        Surface(
            ...
            Column(
                ...
                Button(
                    onClick = { onRegistrationClick(SNO, JobPost, email, password) },
                    shape = RoundedCornerShape(6.dp),
                ...
                TextButton(onClick = { /*onLoginiClick*/ }) {
                    Text(
                        "Войти",
                        color = DeepBlue,
...
fun RegistrationPreview() {
    _root_ide_package_.ru.sicampus.bootcamp2026.ui.theme.AndroidBootcamp2026FrontendTheme {
        RegistrationScreen (
            onRegistrationClick = {SNO, JobPost, email, password ->
                println("xnj-nj")
            }
        )
    }
